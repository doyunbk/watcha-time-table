class CoursesController < ApplicationController
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:code, :title, :description, :professor, :location, :capacity, :start_time, :end_time, dayofweek: [])
    end
    ...
    def courses
      query = Course.ransack(title_or_code_cont_any: search_query)
